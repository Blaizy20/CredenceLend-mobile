...
export default function Login() {
  ...
  return (
    <>
      ...
      {/* ── Login Form ───────────────────────────────────────────────────── */}
      <div className="min-h-[100dvh] bg-background flex flex-col items-center justify-center px-6 py-12 relative overflow-hidden">
        ...
        >
          ...
          <div className="mb-10 text-center">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-[2rem] bg-gradient-to-br from-primary to-primary-dim shadow-2xl shadow-primary/20 mb-6">
              <img src={loginLogo} alt="Login Logo" className="w-16 h-16 object-contain rounded-xl" />
            </div>
            ...
            <p className="text-on-surface-variant text-xs mt-3 font-bold tracking-[0.2em] uppercase opacity-60">Customer Portal</p>
          </div>

          {/* Login Container */}
          <div className="w-full bg-surface-container-low rounded-[2rem] p-8 shadow-xl shadow-slate-200 border border-outline-variant/10 backdrop-blur-sm">
            <div className="mb-8">
